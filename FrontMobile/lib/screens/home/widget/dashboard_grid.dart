...
class DashboardGrid extends StatelessWidget {
            ...
            return Center(
              child: GridView.builder(
                ...
                itemBuilder: (context, index) {
                  return _GridItemWidget(gridItemList[index],
                      _getLatestDataForSubtitle(index, user, _bloc, context));
                },
              ),
            );
          },
  ...
  String _getLatestDataForSubtitle(
      int index, User user, HomeBloc bloc, BuildContext context) {
    switch (index) {
      case 0:
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () => Navigator.of(context)
          .push(FadeRouteBuilder(page: gridItem.widgetScreen)),
      child: GridTile(
        child: Padding(
          padding:
              EdgeInsets.all(MediaQuery.of(context).size.shortestSide * 0.025),
          child: new Material(
